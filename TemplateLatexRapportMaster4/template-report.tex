...
\title{The Sketch-Based Animation of Dancing Couples} %\\\vspace{-1ex}\rule{10ex}{0.5pt} \\sub-title} 
...
\begin{abstract}
I would like to express my sincere gratitude to both my supervisers for their invaluable assistance and comments in reviewing this report.
\end{abstract}
